...
The stone provided the key to deciphering Egyptian hieroglyphics, as it contains the same text in three scripts: Ancient Egyptian hieroglyphics, Demotic script, and Ancient Greek.

## Discovery

Discovered in 1799 by French soldiers during Napoleon's Egyptian campaign, the stone is now housed in the British Museum.
